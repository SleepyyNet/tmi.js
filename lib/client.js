                ...
                case "USERSTATE":
                    ...
                    if (message.tags["user-type"] === "mod") {
                        ...
                        if (this.moderators[this.lastJoined].indexOf(this.username) < 0) {
                          ...
                          this.emit("mod", channel, this.username, true);
                        }
                    }
            ...
            switch(message.command) {
                case "MODE":
                    if (msg === "+o") {
                        ...
                        this.emit("mod", channel, message.params[2], message.params[2] === this.username);
                    }
                    else if (msg === "-o") {
                        ...
                        this.emit("unmod", channel, message.params[2], message.params[2] === this.username);
                    }
                    break;
...
client.prototype._updateEmoteset = function _updateEmoteset(sets) {
    ...
    this.api({
        ...
        if (!err) {
          ...
          this.emit("emoticon_images", this.emotesets);
